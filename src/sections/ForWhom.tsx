...
const cards = [
  {
    icon: Lightbulb,
    title: "Экспертам",
    text: "Тем, кто хочет перестать объяснять «как умеется» и начать строить сильные, понятные и результативные продукты.",
  ...
  },
  {
    ...
    text: "Тем, кто уже работает с курсами, но хочет выйти из операционки и перейти к системной работе с продуктом и линейкой.",
