...
export function Hero() {
  ...
  return (
    <section className="min-h-screen bg-gradient-to-b from-white via-white to-orange-5 py-16 lg:py-24 relative overflow-hidden">
      ...
      >
        ...
        <div className="absolute bottom-20 right-20 w-56 h-56 bg-gradient-to-br from-orange-2 to-orange-4 rounded-full blur-3xl opacity-25 animate-float-slower" />
      ...
      <div className="absolute inset-0 -z-10 lg:hidden pointer-events-none">
        <div className="absolute top-10 right-5 w-40 h-40 bg-gradient-to-br from-orange-1 to-orange-4 rounded-full blur-2xl opacity-20 animate-float-slow" />
      ...
      <Container>
        <div className="max-w-2xl mx-auto lg:max-w-4xl flex flex-col items-center justify-center min-h-[70vh]">
          <motion.div
          ...
          >
            ...
            <motion.div
              ...
              className="inline-flex items-center gap-3 px-6 py-3 rounded-xl bg-orange-4 border-2 border-orange-1 text-text-primary font-bold"
            >
              <Calendar className="w-5 h-5 text-orange-1" />
            ...
            <motion.div
              ...
              className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-orange-5 text-orange-1 font-semibold text-sm"
            >
